...
public class ApplicationRejectThread extends Thread {
    private final Application application;
    private final ApplicationRepository applicationRepository;
    private final ConnectionProvider connectionProvider;

    public ApplicationRejectThread(Application application, ConnectionProvider connectionProvider) {
    ...
    @Override
    public void run() {
        applicationRepository.reject(application.getId());
    }
}
