...
public class ApplicationApproveThread extends Thread {
    private final Application application;
    private final ApplicationRepository applicationRepository;
    private final ConnectionProvider connectionProvider;

    public ApplicationApproveThread(Application application, ConnectionProvider connectionProvider) {
    ...
    @Override
    public void run() {
        applicationRepository.approve(application.getId());
    }
}
