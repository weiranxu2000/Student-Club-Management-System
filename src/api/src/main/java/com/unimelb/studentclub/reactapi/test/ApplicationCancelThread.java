...
public class ApplicationCancelThread extends Thread {
    private final Application application;
    private final ApplicationRepository applicationRepository;
    private final ConnectionProvider connectionProvider;

    public ApplicationCancelThread(Application application, ConnectionProvider connectionProvider) {
    ...
    @Override
    public void run() {
        applicationRepository.cancel(application.getId());
    }
}
