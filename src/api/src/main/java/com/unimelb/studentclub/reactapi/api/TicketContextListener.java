...
@WebListener
public class TicketContextListener implements ServletContextListener {
    static final String Ticket_SERVICE = "ticketService";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        sce.getServletContext().setAttribute(Ticket_SERVICE, new TicketService(new TicketRepositoryImpl(connectionProvider)));
