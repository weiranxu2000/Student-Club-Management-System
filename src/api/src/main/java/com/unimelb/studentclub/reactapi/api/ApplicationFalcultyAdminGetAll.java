...
public class ApplicationFalcultyAdminGetAll extends HttpServlet {
...
//        }
        ...
        List<Application> applicationList = applicationService.getAllApplication(req);
        ...
        for (Application application : applicationList) {
            ...
            jsonObject.put("club_name",application.getClubName());
