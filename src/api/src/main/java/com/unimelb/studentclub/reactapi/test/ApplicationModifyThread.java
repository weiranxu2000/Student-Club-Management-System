...
public class ApplicationModifyThread extends Thread {
    private final Application application;
    private final ApplicationRepository applicationRepository;
    private final ConnectionProvider connectionProvider;

    public ApplicationModifyThread(Application application, ConnectionProvider connectionProvider) {
    ...
    @Override
    public void run() {
        applicationRepository.modify(application);
    }
}
